...
\begin{tikzpicture}[scale=0.8,every node/.style={minimum size=1cm},on grid]
	...
	\begin{scope}[
		...
		\node[anchor=south,inner sep=0,xshift=-20pt,yshift=10pt,fill=white] at (-0.5,2)
			{\includegraphics[width=4cm]{doublesight_dual_monitor.pdf}};
		\node[anchor=south,inner sep=0,xshift=0pt,yshift=8pt] at (2,2)
			{\includegraphics[width=2.5cm]{xdvi.png}};
		\node[anchor=south,inner sep=0,xshift=-5pt,yshift=8pt] at (5,2)
			{\includegraphics[width=3.0cm]{okular_backend_ps.png}};
		\node[anchor=south,inner sep=0,xshift=20pt,yshift=8pt] at (7.5,2)
			{\includegraphics[width=3.5cm]{acrobat_screenshot.png}};

		\fill[black]
			(7.5,2) node[below right,,xshift=-20pt,yshift=-5pt,scale=.9,text width=2.5cm,text centered,fill=white]
			...
			(5.1,1.9) node[below right,xshift=-20pt,scale=.9,text width=2cm,text centered,fill=white]
				{\textsf{\bfseries Ghostview}\\ \textsf{\bfseries PSview}\\ \textsf{\bfseries Okular}}
			(1.9,1.9) node[below right,xshift=-10pt,scale=.9,text width=2cm,text centered,fill=white]
				{\textsf{\bfseries Yap}\\ \textsf{\bfseries Xdvi}}
			(-0.5,2) node[below right,xshift=-20pt,yshift=-5pt,scale=.9,text width=2.5cm,text centered,fill=white]
