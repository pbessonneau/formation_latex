...
\section{L'histoire en trois mots...}
      ...
      \frametitle{L'histoire en trois mots...}
...
\section{Qu'est ce que \latex ?}
      ...
      \begin{frame}[containsverbatim]
      \frametitle{Un langage de mise en forme...}
      ...
      \begin{frame}[containsverbatim]
      \frametitle{Un petit exemple de code \latex}
...
\end{Verbatim}
    	...
    	\end{frame}
      \begin{frame}[containsverbatim]
      \frametitle{Phases pour la production d'un document}
...
\section{Avantages et inconvénients}
      ...
      \begin{frame}[containsverbatim]
      \frametitle{Les avantages de \latex}
     ...
     \begin{frame}[containsverbatim]
      ...
      \begin{frame}[containsverbatim]
      \frametitle{Les inconvénients de \latex}
...
\end{Verbatim}				
      ...
      \frametitle{En vrai...}
    	...
    	\end{frame}
			...
			\begin{frame}[containsverbatim]
      \frametitle{Les éditeurs de texte intelligents}
...
\section{Les éditeurs améliorés pour \latex}
      ...
      \frametitle{En vrai...}
    	...
    	\end{frame}
			...
			\begin{frame}[containsverbatim]
      	\frametitle{\href{http://www.xm1math.net/texmaker/}{\TeX Maker}}
    	...
    	\end{frame}
			...
			\begin{frame}[containsverbatim]
      	\frametitle{\href{http://www.tug.org/texworks/}{\TeX Works}}
    	...
    	\end{frame}
			...
			\begin{frame}[containsverbatim]
      	\frametitle{\href{http://www.texniccenter.org/}{\TeX nicCenter}}
...
\section{Compiler un document \latex sur son poste de travail}
			...
			\begin{frame}[containsverbatim]
      \frametitle{Oui mais le compilateur ?}
    	...
    	\end{frame}
			...
			\begin{frame}[containsverbatim]
      \frametitle{FramaKey, Paquet \latex}
    	...
    	\end{frame}
			...
			\begin{frame}[containsverbatim]
      \frametitle{\MikTeX, version portable}
...
\section{Les parties du code}
      ...
      \begin{frame}[containsverbatim]
      	\frametitle{Structure d'un fichier \latex}
...
\end{Verbatim}				
			...
			\begin{frame}[containsverbatim]
				\frametitle{\latex est un langage...}
...
\section{Les packages}
      ...
      \frametitle{Les packages}
    	...
    	\begin{frame}[containsverbatim]
    	\frametitle{Le paquet \textit{inputenc}}
...
Le paquet \emph{inputenc} permet de définir le format de fichier texte (Latin1, UTF-8, ...). Il est important car il permettra à \latex de reconnaitre notamment les caractères accentués.
    	...
    	\begin{frame}[containsverbatim]
    	\frametitle{Le paquet \textit{babel}}
...
\end{Verbatim}
    	...
    	\begin{frame}[containsverbatim]
    	\frametitle{Un package tout à fait inutile}
...
\section{L'encodage des caractères}
		...
		\begin{frame}[containsverbatim]
      \frametitle{L'encodage des caractères en quelques mots...}
...
L'autre exemple type est le copier-coller. Le copier-coller de Word dans une éditeur de texte peut s'avérer problématique. 
    	...
    	\end{frame}
			...
			\begin{frame}[containsverbatim]
      \frametitle{Indiquer à \latex d'utiliser un autre format d'encodage}
...
\end{Verbatim}
    	...
    	\end{frame}
			...
			\begin{frame}[containsverbatim]
      \frametitle{La conversion de fichier texte}
