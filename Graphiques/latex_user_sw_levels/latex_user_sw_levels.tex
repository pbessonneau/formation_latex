...
\begin{tikzpicture}[scale=0.5,every node/.style={minimum size=1cm},on grid]
	...
	\begin{scope}[
		...
		\node[anchor=south,inner sep=0,xshift=-20pt,yshift=10pt,fill=white] at (-0.5,2)
			{\includegraphics[width=4cm]{Graphiques/latex_user_sw_levels/doublesight_dual_monitor.pdf}};
		\node[anchor=south,inner sep=0,xshift=0pt,yshift=8pt] at (2,2)
			{\includegraphics[width=2.5cm]{Graphiques/latex_user_sw_levels/xdvi.png}};
		\node[anchor=south,inner sep=0,xshift=-5pt,yshift=8pt] at (5,2)
			{\includegraphics[width=3.0cm]{Graphiques/latex_user_sw_levels/okular_backend_ps.png}};
		\node[anchor=south,inner sep=0,xshift=20pt,yshift=8pt] at (7.5,2)
			{\includegraphics[width=3.5cm]{Graphiques/latex_user_sw_levels/acrobat_screenshot.png}};
